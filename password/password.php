<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if ($numExistRows > 0) {
        ...
        $insertSql = "INSERT INTO poll(title,question,candidate1,candidate2,candidate3,candidate4,candidate5,email,password,PollDate) VALUES('$title','$purpose','$candidate1','$candidate2','$candidate3','$candidate4','$candidate5','$email','$hash','$polldate');";
      $result = mysqli_query($conn, $insertSql);
      

      if ($result){  
        $createsql = "CREATE TABLE $nospacetitle (email varchar(255), candidateVoted varchar(255) , timevoted datetime);";
